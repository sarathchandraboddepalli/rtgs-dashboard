...
from sqlalchemy import String, Float, Integer, Boolean, DateTime, Date, Text, ForeignKey, func, UniqueConstraint
...
class Scheme(Base):
    ...
    __table_args__ = (UniqueConstraint('name', 'district', name='uq_scheme_name_district'),)
